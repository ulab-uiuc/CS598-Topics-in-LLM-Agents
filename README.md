...
For **survey paper/report submission(draft)**:
  ...
  -  **Page Limitation:** 📄 (Note: There is no upper limit on page length, but evaluations will be based on quality, not quantity.Excluding references):
	•	Groups of 3 students: at least 9 pages
	•	Groups of 2 students: at least 8 pages
	•	Groups of 4 students: at least 10 pages
...
For **review and response**:
  ...
  - **Guidelines**: See slides of review&rebuttal tips [here](Slides/Review_Rebuttal.pptx)
